...
public class CustomerBean {
    ...
    public ArrayList<CustomerBean> getChartData(String id) throws SQLException, ClassNotFoundException{
        ...
        String sql = "SELECT * FROM (SELECT SUM(AMOUNT), DATE_OF_PURCHASE FROM CRM.CUSTOMERDB WHERE ENTERPRISE_ID =? GROUP BY DATE_OF_PURCHASE ORDER BY DATE_OF_PURCHASE DESC) WHERE ROWNUM<=7";
